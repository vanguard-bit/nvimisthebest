...
local workspace_dir = vim.env.HOME .. '\\jdtls-workspace\\' .. project_name .. "\\src"
...
local config = {
  ...
  cmd = {
    ...
    '-Dlog.protocol=true',
    '-Dlog.level=ALL',
    '-javaagent:' .. 'C:\\Users\\Prajwal\\AppData\\Local\\nvim-data\\mason\\share\\jdtls\\lombok.jar',
    '-Xmx4g',
